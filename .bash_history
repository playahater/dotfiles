...
ls -la
clear
strace firefox 2> log.firefox
clear
strace firefox 2> log.firefox
clear
ls 
ls 
ls dfdsafasdfasdflkajsdflkjasldjflasjdfjsadjf :
vim
clear
ls sadfad 
ls sadfad  
...
echo $(d=/proc/$(pidof plugin-container)/fd; ls --color=no  -l $d | gawk '/\/tmp\/Flash/ {print "'$d'/" $9}' ) 
echo $(d=/proc/$(pidof plugin-container)/fd; ls --color=no  -l $d | gawk '/\/tmp\/Flash/ {print "'$d'/" $9}' ) 
for f in $(file /proc/$(pidof luakit)/fd/*|gawk '/\/tmp\/Flash/ {print $1}'); do mplayer ${f%:}; done
echo $(d=/proc/$(pidof plugin-container)/fd; ls --color=no  -l $d | gawk '/\/tmp\/Flash/ {print "'$d'/" $9}' ) 
for f in $(file /proc/$(pidof luakit)/fd/*|gawk '/\/tmp\/Flash/ {print $1}'); do mplayer ${f%:}; done
