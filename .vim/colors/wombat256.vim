...
call <SID>X("CursorColumn",	"",			"2d2d2d",	"")
			...
			"Question
			"IncSearch
call <SID>X("Search",		"444444",	"597418",	"italic")
...
call <SID>X("StatusLineNC",	"857b6f",	"444444",	"none")
			...
			"Menu
			"WildMenu
call <SID>X("Pmenu",		"121212",	"444444",	"")
call <SID>X("PmenuSel",		"121212",	"caeb82",	"")
call <SID>X("PmenuSbar",	"121212",	"caeb82",	"")
call <SID>X("PmenuThumb",	"121212",	"caeb82",	"")
call <SID>X("WarningMsg",	"ff0000",	"",			"")
			...
			"Directory
			"DiffAdd
call <SID>X("TabLine",		"f6f3e8",	"121212",	"italic")
call <SID>X("TabLineSel",	"FF7700",	"121212",	"italic")
call <SID>X("TabLineFill",	"f6f3e8",	"121212",	"italic")
			"DiffChange
			"DiffDelete
			"DiffText
